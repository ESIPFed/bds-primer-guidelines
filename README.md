...
It can be seen as a rendered webpage [here](https://esipfed.github.io/bds-primer-guidelines/). It can be cited via: 

ESIP Biological Data Standards Cluster, Formel, S., Huelsman, K., Brenskelle, L., & Stap, T. van . der . (2025). ESIP Biological Data Standards (BDS) Cluster: Primer Guidelines (v1.0.1). Zenodo. [https://doi.org/10.5281/zenodo.17526612](https://doi.org/10.5281/zenodo.17526612)
...
If you would like to suggest changes or additions to the current version of the guideline documents, please use the [GitHub issues](https://github.com/ESIPFed/bds-primer-guidelines/issues/new/choose) to document your request.
