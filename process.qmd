...
```{mermaid}
%%| label: fig-workflow
%%| fig-cap: "Contributor credit workflow: contributors self-document CRediT roles in YAML, which GitHub Actions translates into standard citation files."
...
**Cluster Wiki:** [wiki.esipfed.org/Biological\_Data\_Standards\_Cluster](https://wiki.esipfed.org/Biological\_Data\_Standards\_Cluster)  
**ESIP Blog Post (2022):** [A Primer for Data Managers](https://www.esipfed.org/guest-blog-a-primer-for-data-managers/)  
**January 2024 ESIP Meeting Session (video):** [YouTube](https://www.youtube.com/watch?v=BocpE\_hN7iA)  
**Behind the Scenes Poster (Summer 2025):** [Figshare](https://esip.figshare.com/articles/poster/Behind\_the\_scenes\_collaborative\_creation\_of\_the\_Biological\_Data\_Standards\_Primer\_Guide/29824976)  


[^1]:  This became an ideal we worked toward, but sometimes it was more functional to use other formats.